...
export default function AdminSettingsPage() {
  ...
  const categories = [
    { key: 'GENERAL', label: 'Algemeen', keys: ['SITE_NAME', 'REGISTRATION_OPEN'] },
    { key: 'MAINTENANCE', label: 'Maintenance', keys: ['MAINTENANCE_MODE'] },
            ...
            <div className="space-y-3">
              {cat.keys.map((k) => (
                <div key={k} className="flex items-center gap-3">
                  ...
                  />
                  <Button onClick={() => save(k)} size="sm" className="rounded-xl bg-blue-gradient text-white">
